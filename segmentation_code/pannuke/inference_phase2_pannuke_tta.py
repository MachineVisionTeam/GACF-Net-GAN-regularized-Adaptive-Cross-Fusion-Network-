"""Phase 2 (BHF-Net+GAN) TTA inference on PanNuke.
Loads G from {G_state_dict, D_state_dict} ckpt and applies 8-aug TTA.
"""
...
def main():
    ...
    if args.ckpt is None:
        args.ckpt = f"/home/sbarua/fanseg/checkpoints/pannuke_phase2/split{args.split}/best.pt"
    ...
    g_state = cp["G_state_dict"] if "G_state_dict" in cp else cp["model"]
    ...
    print()
    print("=" * 75)
    print(f"  PanNuke split {args.split} — Phase 2 + TTA results")
    print("=" * 75)
    ...
    out_json = f"/home/sbarua/fanseg/predictions/pannuke/split{args.split}/_phase2_tta_eval_summary.json"
