"""Phase 2 (BHF-Net + GAN) trainer on PanNuke.
...
def parse_args():
    ...
    p.add_argument("--out_dir", default="/home/sbarua/fanseg/checkpoints/pannuke_phase2")
...
def main():
    ...
    if args.phase1_ckpt is None:
        args.phase1_ckpt = f"/home/sbarua/fanseg/checkpoints/pannuke_phase1/split{args.split}/best.pt"
    ...
    G = FanSegPanNuke(depths=depths, decoder_ch=args.decoder_ch).to(device)
