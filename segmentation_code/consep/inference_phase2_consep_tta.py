"""Phase 2 (BHF-Net+GAN) TTA inference on CoNSeP.
...
def main():
    ...
    if args.ckpt is None:
        args.ckpt = f"/home/sbarua/fanseg/checkpoints/consep_phase2/split{args.split}/best.pt"
    ...
    print()
    print("=" * 75)
    print(f"  CoNSeP split {args.split} — Phase 2 + TTA results")
    print("=" * 75)
    ...
    out_json = f"/home/sbarua/fanseg/predictions/consep/split{args.split}/_phase2_tta_eval_summary.json"
